...
import { Dai, Dai__factory } from '@typechained';
...
describe('DAI @skip-on-coverage', () => {
  ...
  before(async () => {
    ...
    const daiContractFactory = await ethers.getContractFactory<Dai__factory>('Dai');
    dai = daiContractFactory.attach(DAI_ADDRESS);
