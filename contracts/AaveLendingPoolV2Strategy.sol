...
abstract contract AaveLendingPoolV2Strategy is BaseStrategy {
  ...
  /// @dev from the doc: `balanceOf` will always return the most up to date balance of the user, which includes their principal balance + the yield generated by the principal balance
